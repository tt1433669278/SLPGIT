...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        fs = cpstopoFakeScheduling(G=network,
                                   Tmax=4000, c_capture=1e-40, w_1=0.04, w_2=0.02,
        ...
        print "yikaishi", np.mean(restEnergy)
        # fs.fakeScheduling()
        ...
        print "\nThe safety is", fs.safety, "\nThe MeanDelay is", mean_delay, "The neanrestEnergy is", np.mean(restEnergy)
    print "\nThe safety is", np.mean(ave_safe_set), "\nThe MeanDelay is", np.mean(ave_delay_set), "The neanrestEnergy is", np.mean(ave_energy_set)
    fs.attacker.display()