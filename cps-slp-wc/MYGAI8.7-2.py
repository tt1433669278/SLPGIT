...
class cpstopoFakeScheduling:
    ...
    def calculateFakeSource(self, node, Ti):
        ...
        sifenmu = self.w_2 * math.log((ave_dist + numI), 2.7) + (1 - self.w_2) * np.exp(CP - numC * 1. / numI) + nodetosource
...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        fs = cpstopoFakeScheduling(G=network,
                                   Tmax=5000, c_capture=1e-40, w_1=0.01, w_2=0.9,
        ...
        fs.safety, fs.listDelay, ave_Consump_set = fs.scheduingFakeMessages()  # 虚假源调度与网络路由事件
    ...
    plt.legend()
    plt.savefig(r'D:\project\cps-slp-wc\graph\three\w_1\8.6\w_1=0.01-w_2=0.9.png')
    # plt.show()
