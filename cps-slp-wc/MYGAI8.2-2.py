...
if __name__ == '__main__':
    ...
    for i in range(25):
        ...
        fs = cpstopoFakeScheduling(G=network,
                                   Tmax=4000, c_capture=1e-40, w_1=0.02, w_2=0.1,
    ...
    print "\nThe safety is", ave_safe_set, "\nThe MeanDelay is", ave_delay_set, "The neanrestEnergy is", ave_energy_set
    # fs.attacker.display()
    ...
    plt.legend()
    plt.savefig(r'D:\project\cps-slp-wc\graph\three\w_1\8.1\w_1=0.6-w_2=0.1-.png')
    # plt.show()