...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        print " "
        print 'w1=0.2 变化网络规模：', network.nodeNumber, network.areaLength  # ............................

        fs = cpstopoFakeScheduling(G=network,
                                   Tmax=4000, c_capture=1e-40, w_1=0.2, w_2=w_2,  # ............................
    ...
    plt.xlabel('w_2')
    plt.ylabel('Values')
    plt.title('w_1:0.2 Variation of safe with w_2')  # ............................
    plt.legend()
    # plt.savefig(r'D:\project\cps-slp-wc\graph\w_2 no bian\two banben\road1_w_1_0.2_safe.png')
    ...
    plt.xlabel('w_2')
    plt.ylabel('Values')
    plt.title('w_1:0.2 Variation of energy-delay with w_2')  # ............................
    plt.legend()
    # plt.savefig(r'D:\project\cps-slp-wc\graph\w_2 no bian\two banben\road1_w_1_0.2_ead.png')
